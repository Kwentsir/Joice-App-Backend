class Api::V1::JournalController < ApplicationController
    ...
    def create
        ...
        if @journal.save
            ...
            render json: { message: 'Failed to create journal', errors: @journal.errors.full_messages }, status: :unprocessable_entity
        end
    end
    ...
    def destroy
        if @journal.destroy
            ...
            render json: { message: 'Failed to delete journal', errors: @journal.errors.full_messages }, status: :unprocessable_entity
        end
    end
    ...
    def update
        if @journal.update(journal_params)
            ...
            render json: { message: 'Failed to update journal', errors: @journal.errors.full_messages }, status: :unprocessable_entity
        end
    end
